...
function bishkek_park_translatable_strings() {
	return array(
		...
		'Bishkek Park: Homepage' => array(
			...
			'home_cinema_label_short'      => 'Сегодня',
		...
		// «Остались вопросы?» CTA reuses funcity_cta_title/subtitle/text and the
		// footer's tel number rather than duplicating them — see
		// template-parts/about/page-about.php, which reuses the
		// bp-funcity-cta markup/classes verbatim.
		'Bishkek Park: About' => array(
			'about_back'                     => 'Назад на главную',
			'about_hero_title'               => 'Крупнейший ТРЦ европейского класса в Кыргызстане',
			'about_hero_text'                => 'ТРЦ «Bishkek Park» распахнул свои двери в 2013 году, навсегда изменив представление жителей столицы о качественном досуге и шоппинге',
			'about_feature_foodcourt_title'  => 'Фудкорт',
			'about_feature_foodcourt_text'   => 'Обширная зона с вкусами со всего мира - для любого бюджета.',
			'about_feature_brands_title'     => 'Мировые бренды',
			'about_feature_brands_text'      => 'Флагманские магазины и актуальные коллекции - всё в одном месте.',
			'about_feature_cinema_title'     => 'Кинотеатр',
			'about_feature_cinema_text'      => 'Ультрасовременный пятизальный кинотеатр «Синематика».',
			'about_feature_funcity_title'    => 'FunCity',
			'about_feature_funcity_text'     => 'Гигантская игровая зона для детей - развлечения, безопасность и комфорт.',
			'about_leadership_title'         => 'Руководство ТРЦ «Bishkek Park»',
			'about_milestones_title'         => 'Этапы нашего развития',
			'about_milestones_text'          => 'С момента закладки фундамента и до сегодняшнего дня мы постоянно совершенствуемся, чтобы предвосхищать ваши самые смелые ожидания.',
		),
	);
}
